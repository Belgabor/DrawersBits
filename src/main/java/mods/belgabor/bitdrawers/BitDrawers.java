...
@Mod(modid = BitDrawers.MODID, version = BitDrawers.VERSION, name = BitDrawers.MODNAME, dependencies = "required-after:chiselsandbits;required-after:StorageDrawers@[1.10.2-3.2.1,);required-after:Chameleon")
@ChiselsAndBitsAddon
